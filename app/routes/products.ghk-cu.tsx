...
<p>
GHK-CU is a small copper-binding peptide made from three amino
acids. GHK occurs naturally, and the “CU” refers to the copper
ion attached to it.
</p>

<p>
The peptide acts as a carrier that holds copper and makes it
available during certain cellular processes. Researchers study
how this copper-peptide complex communicates with cells and
affects gene activity.
</p>

<p>
Laboratory research commonly examines its connection to copper
transport, cellular stress, and the production and breakdown of
collagen and other materials that support the space around
cells.
</p>
</div>
