...
export default function MelanotanIIProduct() {
        ...
        <div className="grid gap-12 lg:grid-cols-2">
          ...
          <div className="overflow-hidden rounded-3xl border border-slate-800 bg-white">
            <div className="aspect-square">
              <img
                src="/avios-melanotanII-product.PNG"
                alt={`Melanotan II ${selectedSize.label}`}
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="mt-4 max-w-xl space-y-4 text-lg leading-8 text-slate-400">
              <p>
                Melanotan II is a synthetic cyclic research peptide modeled
                after alpha-melanocyte-stimulating hormone, commonly
                abbreviated as alpha-MSH.
              </p>

              <p>
                Its cyclic structure is studied in controlled laboratory models
                involving peptide stability and interactions with melanocortin
                receptor systems.
              </p>

              <p>
                Researchers examine Melanotan II to better understand receptor
                binding, melanocortin signaling, and related biochemical
                pathways under controlled experimental conditions.
              </p>
            </div>
            ...
            <AddToCartButton
              id={`melanotan-ii-${selectedSize.label
                .replace(/\s+/g, "-")
                .toLowerCase()}`}
              name="Melanotan II"
