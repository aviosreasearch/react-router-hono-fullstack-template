...
export const meta = buildProductMeta("epithalon");
...
export default function EpithalonProduct() {
  const [selectedSize, setSelectedSize] = useState(sizes[0]);

  return (
    <main className="min-h-screen bg-slate-950 text-white">
      <ProductSeo slug="epithalon" />
      {/* Navigation */}
        ...
        <div className="grid gap-12 lg:grid-cols-2">
          ...
          <div className="overflow-hidden rounded-3xl border border-slate-800 bg-white">
            <div className="aspect-square">
              <img
                src="/avios-epithalon-product.PNG"
                alt={`Epithalon ${selectedSize.label}`}
            ...
            <div className="mt-10 border-t border-slate-800 pt-8">
              ...
              <div className="mt-5 space-y-4">
                <div className="flex items-center justify-between border-b border-slate-800 pb-4">
                  ...
                  <span className="font-medium">Epithalon</span>
                </div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16">
        <div className="rounded-2xl border border-slate-800 bg-slate-900 p-8">
          ...
          <p className="mt-4 max-w-4xl leading-7 text-slate-400">
            Epithalon products offered by Avios Research are presented solely
