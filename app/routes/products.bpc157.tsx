...
export const meta = buildProductMeta("bpc-157");
...
export default function Bpc157Product() {
  const [selectedSize, setSelectedSize] = useState(sizes[0]);

  return (
    <main className="min-h-screen bg-slate-950 text-white">
      <ProductSeo slug="bpc-157" />
      {/* Navigation */}
        ...
        <div className="grid gap-12 lg:grid-cols-2">
          ...
          <div className="overflow-hidden rounded-3xl border border-slate-800 bg-white">
            <div className="aspect-square">
              <img
                src="/avios-bpc157-product.PNG"
                alt={`BPC-157 ${selectedSize.label}`}
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="mt-4 max-w-xl space-y-4 text-lg leading-8 text-slate-400">
              <p>
                BPC-157 is a synthetic research peptide composed of 15 amino
                acids. It is based on a peptide sequence associated with a
                naturally occurring gastric protein.
              </p>

              <p>
                Laboratory studies examine BPC-157 in controlled models
                involving peptide stability, cellular signaling, and molecular
                interactions within different tissue environments.
              </p>

              <p>
                Researchers also use BPC-157 to investigate biochemical
                pathways associated with cellular responses, vascular
                signaling, and extracellular tissue structures.
              </p>
            </div>
            ...
            <div className="mt-10 border-t border-slate-800 pt-8">
              ...
              <dl className="mt-6 space-y-4 text-sm">
                <div className="flex items-center justify-between gap-6 border-b border-slate-800 pb-4">
                  ...
                  <dd className="font-semibold text-slate-200">BPC-157</dd>
                </div>
