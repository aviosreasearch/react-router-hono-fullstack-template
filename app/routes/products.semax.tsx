...
export const meta = buildProductMeta("semax");
...
export default function SemaxProduct() {
  const [selectedSize, setSelectedSize] = useState(sizes[0]);

  return (
    <main className="min-h-screen bg-slate-950 text-white">
      <ProductSeo slug="semax" />
      {/* Navigation */}
      ...
      <section className="mx-auto max-w-7xl px-6 py-16">
        <div className="rounded-2xl border border-slate-800 bg-slate-900 p-8">
          ...
          <p className="mt-4 max-w-4xl leading-7 text-slate-400">
            Semax products offered by Avios Research are presented solely as
