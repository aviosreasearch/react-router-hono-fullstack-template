...
export default function GlowProduct() {
        ...
        <div className="grid gap-12 lg:grid-cols-2">
          ...
          <div className="overflow-hidden rounded-3xl border border-slate-800 bg-white">
            <div className="aspect-square">
              <img
                src="/avios-glow-product.PNG"
                alt={`GLOW ${selectedSize.label}`}
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="mt-4 max-w-xl text-lg leading-8 text-slate-400">
              Research peptide blend supported by organized product
              information, lot records, and available laboratory documentation.
            </p>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16">
        <div className="rounded-2xl border border-slate-800 bg-slate-900 p-8">
          ...
          <p className="mt-4 max-w-4xl leading-7 text-slate-400">
            GLOW products offered by Avios Research are presented solely as
