...
Membership discounts will be applied automatically after
recurring payment processing and membership verification are
connected.
</p>

<p className="mt-3 leading-7 text-slate-400">
Founding members will receive 15% off eligible product
purchases while their membership remains continuously active.
Standard members will receive 10% off eligible product
purchases.
</p>
...
The checkout page is working. Secure payment processing and
verified membership pricing will be connected before
launch.
</p>
</div>
) : null}
...
Membership savings, shipping, and any applicable taxes will
be calculated during secure payment.
</p>
</div>
</div>
