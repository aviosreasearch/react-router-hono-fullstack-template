            ...
            <div className="space-y-8">
              ...
              <section className="rounded-2xl border border-slate-800 bg-slate-900/40 p-7">
                ...
                <p className="mt-4 leading-7 text-slate-400">
                  Have a private Friends & Family code? Enter it
                  below to verify eligibility for special pricing.
                </p>
                ...
                <div className="mt-5 flex flex-col gap-3 sm:flex-row">
                  <input
                    ...
                    onChange={(event) =>
                      handleFriendsFamilyCodeChange(
                        event.target.value,
                      )
                    }
                    placeholder="Enter code"
                    autoComplete="off"
                    className="min-w-0 flex-1 rounded-lg border border-slate-700 bg-slate-950 px-4 py-3 text-white outline-none transition placeholder:text-slate-600 focus:border-sky-500"
                  />
                  ...
                  <button
                    ...
                    className="rounded-lg border border-sky-500/50 px-5 py-3 font-semibold text-sky-300 transition hover:border-sky-400 hover:text-white disabled:cursor-not-allowed disabled:border-slate-700 disabled:text-slate-500"
                  >
                    {checkingFriendsFamilyCode
                      ? "Checking..."
                      : "Apply"}
                  </button>
                </div>
                ...
                {friendsFamilyApplied ? (
                  <div className="mt-5 rounded-xl border border-sky-500/30 bg-sky-500/10 p-4">
                    <p className="font-semibold text-sky-300">
                      20% Friends & Family discount active
                    </p>

                    <p className="mt-1 text-sm text-slate-400">
                      The discount applies to the eligible product
                      subtotal.
                    </p>
                  </div>
                ) : null}
              ...
              <section className="rounded-2xl border border-slate-800 bg-slate-900/40 p-7">
                ...
                <p className="mt-4 leading-7 text-slate-400">
                  Membership discounts will be applied
                  automatically after recurring payment processing
                  and membership verification are connected.
                </p>

                <p className="mt-3 leading-7 text-slate-400">
                  Founding members will receive 15% off eligible
                  product purchases while their membership remains
                  continuously active. Standard members will receive
                  10% off eligible product purchases.
                </p>

                <p className="mt-3 text-sm leading-6 text-slate-500">
                  Promotional and membership discounts will not be
                  stacked unless specifically stated.
                </p>

                <a
                  href="/membership"
                  className="mt-5 inline-flex font-semibold text-sky-400 transition hover:text-sky-300"
                >
              ...
              <section className="rounded-2xl border border-sky-500/30 bg-sky-500/5 p-7">
                ...
                <div className="mt-5 rounded-xl border border-slate-700 bg-slate-950/60 p-5">
                  <p className="leading-7 text-slate-300">
                    Products offered by Avios Research are sold
                    solely as research materials and are not
                    intended for human consumption, therapeutic
                    use, diagnosis, treatment, or prevention of
                    disease.
                  </p>

                  <p className="mt-4 leading-7 text-slate-400">
                    By completing this purchase, the purchaser
                    confirms that the products are being obtained
                    solely for research purposes and accepts
                    responsibility for their lawful handling,
                    storage, and use.
                  </p>
                </div>
                ...
                <label className="mt-6 flex cursor-pointer items-start gap-4 rounded-xl border border-slate-700 bg-slate-950 p-5">
                  ...
                  <span className="text-sm leading-6 text-slate-300">
                    I confirm that I am purchasing these products
                    solely for research use and not for human
                    consumption.
                  </span>
                </label>
              </section>
            ...
            <aside className="h-fit rounded-2xl border border-slate-800 bg-slate-900/60 p-7 lg:sticky lg:top-6">
              ...
              <div className="mt-6 space-y-3">
                ...
                {friendsFamilyApplied ? (
                  <div className="flex items-center justify-between text-sky-400">
                    <span>
                      Friends & Family Discount (20%)
                    </span>

                    <span className="font-semibold">
                      -$
                      {friendsFamilyDiscount.toFixed(2)}
                    </span>
                  </div>
                ) : null}
              ...
              {!agreementAccepted ? (
                <p className="mt-3 text-center text-xs leading-5 text-slate-500">
                  Research-use acknowledgment is required before
                  continuing.
                </p>
              ) : null}
            </aside>
