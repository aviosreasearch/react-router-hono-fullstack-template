    ...
    <main className="min-h-screen bg-slate-950 text-white">
      ...
      <section className="mx-auto max-w-5xl px-6 py-20">
        ...
        {membershipStatus === "success" && (
          <div className="mx-auto mt-8 max-w-xl rounded-xl border border-emerald-500/40 bg-emerald-500/10 px-5 py-4 text-center text-emerald-200">
            Your founding membership payment was successful.
            Welcome to Avios Research Membership.
          </div>
        )}

        {membershipStatus === "cancelled" && (
          <div className="mx-auto mt-8 max-w-xl rounded-xl border border-amber-500/40 bg-amber-500/10 px-5 py-4 text-center text-amber-200">
            Membership enrollment was canceled. You have not
            been charged.
          </div>
        )}
        ...
        <div className="mx-auto mt-12 max-w-xl rounded-3xl border border-sky-500/40 bg-slate-900 p-8 shadow-2xl">
          <div className="text-center">
            ...
            <p className="mt-2 text-sm leading-6 text-slate-400">
              Available to qualifying early members during the
          ...
          <div className="mt-8 space-y-4">
            ...
            <div className="flex items-start gap-3">
              ...
              <p className="text-slate-300">
                After cancellation, benefits remain available
                through the end of the already-paid billing
                period.
              </p>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <p className="text-slate-300">
                Membership discounts apply to eligible product
                subtotal only.
              </p>
            </div>
          </div>
          ...
          <button
            ...
            className="mt-8 w-full rounded-lg bg-sky-500 px-6 py-3.5 font-semibold text-slate-950 transition hover:bg-sky-400 disabled:cursor-wait disabled:bg-slate-700 disabled:text-slate-300"
          >
            {isStartingCheckout
          ...
          {checkoutError && (
            <p className="mt-4 text-center text-sm leading-6 text-red-300">
              {checkoutError}
            </p>
          )}

          <p className="mt-4 text-center text-xs leading-5 text-slate-500">
            Secure monthly billing is processed by Stripe.
            Membership benefits become active after successful
            payment.
          </p>
        </div>
        ...
        <div className="mx-auto mt-12 max-w-3xl rounded-2xl border border-slate-800 bg-slate-900/40 p-7">
          ...
          <div className="mt-5 space-y-4 leading-7 text-slate-400">
            <p>
              Avios Research Membership is billed monthly until
              canceled. Membership benefits become active only
            ...
            <p>
              ...
              Membership benefits remain available through the
              end of the current paid billing period and expire
              when that billing period ends.
            </p>

            <p>
              If a recurring membership payment fails and the
              membership is no longer considered active,
              membership pricing will no longer be available.
            </p>

            <p>
              Membership discounts do not apply to shipping
              charges, taxes, fees, or other non-product
              charges.
            </p>

            <p>
              Membership benefits are intended for the
              registered member and may not be transferred or
              combined with other promotional discounts unless
              specifically stated.
            </p>
          </div>
        </div>
      ...
      <section className="border-y border-slate-800 bg-slate-900/40">
        <div className="mx-auto max-w-5xl px-6 py-12">
          ...
          <p className="mt-3 max-w-3xl leading-7 text-slate-400">
            Products offered by Avios Research are research
            materials only and are not intended for human
            consumption, therapeutic use, diagnosis, treatment,
