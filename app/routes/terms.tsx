        ...
        <section className="rounded-2xl border border-slate-800 bg-slate-900/60 p-8 shadow-xl">
          ...
          <div className="mt-10 space-y-9 text-sm leading-7 text-slate-300">
            <section>
              ...
              <p className="mt-3">
                By accessing this website, creating an order, or purchasing
            ...
            <section>
              ...
              <p className="mt-3">
                Products offered by Avios Research are sold exclusively for
            ...
            <section>
              ...
              <p className="mt-3">
                ...
                & Refunds Policy. Certain products may not be eligible for
                return once opened or otherwise compromised.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-3">
                ...
                medical advice or a representation that any product is
