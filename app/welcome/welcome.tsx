          ...
          <div>
            ...
            >
              ...
              <p className="mt-4 leading-7 text-slate-400 sm:leading-8">
                ...
                product identification, accessible
                documentation, laboratory report
                verification, and responsible presentation
          ...
          <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 sm:py-20">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="mx-auto mt-4 max-w-2xl leading-7 text-slate-400">
                ...
                $5 per month and receive 7% off eligible
                research product purchases while your
            ...
            <div className="mt-9 text-center">
              <a
                href="/membership"
                className="inline-flex items-center justify-center rounded-lg bg-sky-500 px-7 py-3.5 font-semibold text-slate-950 shadow-[0_10px_35px_rgba(14,165,233,0.3)] transition hover:bg-sky-400"
              >
              ...
              <p className="mt-4 text-xs leading-5 text-slate-500">
                Examples reflect 7% off the listed product
        ...
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-24">
          <div>
            ...
            <p className="mt-4 max-w-2xl leading-7 text-slate-400">
              ...
              category and review associated documentation,
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-5 max-w-xl leading-7 text-slate-300 sm:leading-8">
              ...
              supplier-provided certificates of analysis and
              third-party laboratory reports. Where
              laboratory verification is available, Avios
              will provide a direct verification link.
            </p>
          </div>
        ...
        <div className="mx-auto flex max-w-7xl flex-col gap-7 px-4 py-10 sm:px-6 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-sm text-sm leading-6 text-slate-500">
              All products are sold strictly for laboratory
              research purposes only. Not for human or
              veterinary use or consumption.
            </p>
          </div>
