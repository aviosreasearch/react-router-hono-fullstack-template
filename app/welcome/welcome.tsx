    ...
    <article className="overflow-hidden rounded-2xl border border-slate-800 bg-slate-950">
      ...
      <div className="p-6">
        ...
        {product.slug ? (
          ...
          <span className="mt-6 inline-flex text-sm font-semibold text-slate-600">
            Details coming soon
          </span>
        )}
      </div>
      ...
      <section className="mx-auto max-w-7xl px-6 pb-16 pt-14">
        <div className="grid items-center gap-10 lg:grid-cols-2">
          ...
          <div className="relative hidden min-h-[520px] overflow-hidden rounded-3xl lg:block">
            <div
              className="absolute inset-0 bg-[length:140%] bg-center bg-no-repeat"
              style={{
          ...
          <div className="flex flex-col justify-between gap-6 md:flex-row md:items-end">
            <div>
              ...
              <p className="mt-4 max-w-2xl text-slate-400">
                Browse available research compounds by research category and
                review associated documentation, lot information, and
                laboratory reports.
              </p>
            </div>

            <span className="text-sm text-slate-500">
              Additional compounds coming soon
            </span>
          </div>
          ...
          <div className="rounded-2xl border border-slate-800 bg-slate-900 p-8">
            ...
            <div className="mt-6 space-y-5">
              <div className="flex justify-between border-b border-slate-800 pb-4">
                ...
                <span className="font-semibold">MOTS-C</span>
              </div>
